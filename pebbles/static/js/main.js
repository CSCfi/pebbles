...
var app = angular.module('PBApp', ['ngRoute', 'ngAnimate', 'restangular', 'LocalStorageModule', 'validation.match', 'angularFileUpload', 'schemaForm', 'ui.bootstrap', 'angular-loading-bar', 'angularjs-dropdown-multiselect']);
