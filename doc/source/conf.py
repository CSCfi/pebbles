# -*- coding: utf-8 -*-
#
# pebbles documentation build configuration file, created by
...
version = ".".join([ str(version_info.major),
...
latex_documents = [
    (master_doc, 'pebbles.tex', u'pebbles Documentation',
     u'CSC - Center for Scientific Computing Ltd.', 'manual'),
]
...
man_pages = [
    (master_doc, 'pebbles', u'pebbles Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pebbles', u'pebbles Documentation',
     author, 'pebbles', 'One line description of project.',
     'Miscellaneous'),
]
